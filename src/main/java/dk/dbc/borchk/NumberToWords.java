...
public class NumberToWords {
    ...
    private static AbstractProcessor processor = new CompositeBigProcessor(63);

    public static String getName (int val ) {
        return processor.getName(val);
    }

    public String getNameFromInt(int val) {
        return processor.getName(val);
    }
